...
void setup() {
  ...
  int timeout = 15;  // wait for max. 15 seconds to connect
  while (WiFi.status() != WL_CONNECTED) {
    delay(1000);
    Serial.print(".");
    if (--timeout == 0) {
      Serial.println();
      Serial.println("WiFi connection timout");
      return;
    }
  }
...
void loop() {
  ...
  showBitmapFrom_HTTPS("kevinniuwu.com", "/tinker/bmp", "/", 0, 0, 0, true);
  //showBitmapFrom_HTTPS("66.media.tumblr.com", "/e973c5cdc64003daaa1269fc0f55d305/", "tumblr_inline_mloc3bhRfL1qgy87s.bmp", 0, 0, 0, false);
  //showBitmapFrom_HTTPS("courses.cs.washington.edu", "/courses/csep557/98sp/projects/impressionist/bitmaps/", "gradient-circular.bmp", 0, 0, 0, false);
  Serial.println("done");
  //showBitmapFrom_HTTPS_Buffered("kevinniuwu.com", "/tinker/bmp", "/", 0, 0, 0, false);
